...
#
# def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False, classes_conf=None,
#                         labels=()):
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        if multi_label:
            ...
            if classes_conf is not None:
                conf_thres_list = classes_conf[0].split(",")  # split conf values by comma
